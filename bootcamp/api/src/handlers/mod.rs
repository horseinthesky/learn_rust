...
pub async fn create_question(
    ...
    match handlers_inner::create_question(question.0, questions_dao).await {
        Ok(q) => Ok(Json(q)),
...
pub async fn delete_question(
    ...
    match handlers_inner::delete_question(question_uuid.0, questions_dao).await {
        Ok(_) => Ok(()),
        Err(err) => Err(err.into()),
    }
}
...
pub async fn create_answer(
    ...
    match handlers_inner::create_answer(answer.0, answers_dao).await {
        Ok(q) => Ok(Json(q)),
        Err(err) => Err(err.into()),
    }
}
...
pub async fn read_answers(
    ...
    match handlers_inner::read_answers(question_uuid.0, answers_dao).await {
        Ok(q) => Ok(Json(q)),
        Err(err) => Err(err.into()),
    }
}
...
pub async fn delete_answer(
    ...
    match handlers_inner::delete_answer(answer_uuid.0, answers_dao).await {
        Ok(_) => Ok(()),
        Err(err) => Err(err.into()),
    }
}
